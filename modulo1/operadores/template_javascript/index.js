...
let difererenca = (idade - idadeAmigo) * -1 
console.log("Sua idade é maior do que a do seu amigo?", maior, difererenca) 
...
let numero1 = prompt("Digite um número qualquer inteiro")
let numero2 = prompt("Digite outro número qualquer inteiro")
